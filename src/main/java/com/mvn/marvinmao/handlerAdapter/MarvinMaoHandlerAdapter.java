...
import com.mvn.marvinmao.argumentResolver.ArgumentResolver;
...
@MarvinService("jamesHandlerAdapter")
public class MarvinMaoHandlerAdapter implements HandlerAdapterService {
    //对method方法里的参数进行处理
